...
namespace DataJuggler.Net6
{
    ...
    public class SQLDatabaseConnector
	{
		...
		#region Methods
			...
			public string BuildTableSQL(DataJuggler.Net6.DataTable dataTable)
			{
                ...
                try
                {
                    ...
                    if (NullHelper.Exists(table))
                    {
                        ...
                        foreach (System.Data.DataRow databaseField in schemaTable.Rows)
                        {
                            ...
                            DataJuggler.Net6.DataField field = new DataField();
			...
			#region IsPrimaryKeyUpdateable(DataJuggler.Net6.DataTable table)
			/// <summary>
			...
			public bool IsPrimaryKeyUpdateable(DataJuggler.Net6.DataTable table)
			{
			...
			#region LoadDataRows() +1 overrides
				...
				#region LoadDataRows(DataJuggler.Net6.DataTable table)
				/// <summary>
				/// Loads All Rows For This table
				/// </summary>
				/// <param name="table"></param>
				/// <returns></returns>
				public List<DataRow> LoadDataRows(DataJuggler.Net6.DataTable dataTable)
				{
				...
				#region LoadDataRows(DataJuggler.Net6.DataTable table, string sql)
				/// <summary>
				...
				/// <param name="sql"></param>
				/// <returns></returns>
				public List<DataRow> LoadDataRows(DataJuggler.Net6.DataTable dataTable, string sql)
				{	
                ...
                public List<DataRow> LoadDataRowsWithoutBinaryData(DataTable dataTable, string sql = "")
                {
                    ...
                    {
                        // Create A New row
                        dataRow = new DataJuggler.Net6.DataRow(dataTable);

                        // Clone Fields Collection For This row
                        dataRow.Fields = CloneFields(dataTable.ActiveFields);

                        // Add Each field
                        foreach (DataJuggler.Net6.DataField field in dataTable.ActiveFields)
                        {
                            // Finding field Index
            ...
            public List<DataTable> LoadDataTablesSchema(Database parentDatabase)
			{
				...
				{				
					...
					{	
						// Create A New table
						DataJuggler.Net6.DataTable dataTable = new DataJuggler.Net6.DataTable();
            ...
            public DataJuggler.Net6.DataTable LoadDataTableSchema(Database parentDatabase, string tableName)
            {
                // initial value
                ...
                try
                {
                    ...
                    {
                        // Create A New table
                        DataJuggler.Net6.DataTable dt = new DataJuggler.Net6.DataTable();
			...
			public List<StoredProcedure> LoadStoredProcedures(List<DataTable> tables)
			{
				...
				try
				{
					...
					foreach(System.Data.DataRow dr in ds.Tables["Procedures"].Rows)
					{
						...
						DataJuggler.Net6.StoredProcedure sp = new StoredProcedure();
