...
namespace DataJuggler.Net6
{
	...
	public class DataRow
	{
		...
		private int index;
		private DataJuggler.Net6.DataTable parentTable;
		private string tag;
		#endregion
		...
		#region Constructor
			...
			#region DataRow(DataJuggler.Net6.DataTable ParentDataTable)
			public DataRow(DataJuggler.Net6.DataTable ParentDataTable)
			{
				// Set Parent table
		...
		#region Methods
			...
			#region PrimaryKey()
			public DataJuggler.Net6.DataField PrimaryKey()
			{
				// Create DataField 
				DataJuggler.Net6.DataField NoField = new DataField();
				NoField.FieldName = "void";

				// Search For PrimaryKey
				foreach(DataJuggler.Net6.DataField Field in this.Fields)
				{
		...
		#region Properties
			...
			#region ParentTable
			public DataJuggler.Net6.DataTable ParentTable
			{
				get
				{
					return parentTable;
