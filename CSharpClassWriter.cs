...
namespace DataJuggler.Net6
{
	...
	{  
        ...
        private const string DelegatesReference = "DataJuggler.Net6.Delegates";
        private const string EnumerationsReference = "DataJuggler.Net6.Enumerations";
        #endregion
		...
		#region Methods
            ...
            #region CloneField(DataJuggler.Net6.DataField field,string newObjectName)
            public string CloneField(DataJuggler.Net6.DataField field,string newObjectName)
			{
                // local
                    ...
                    else
                    {
                        ...
                        switch (field.DataType)
				        {
					        ...
					        case DataManager.DataTypeEnum.DataTable:
						        ...
						        dataType =  "DataJuggler.Net6.DataTable";
			...
			#region CreateForEach(DataJuggler.Net6.DataTable table)
			/// <summary>
			/// This method creates a foreach for each field in the table
			/// </summary>
			/// <param name="table"></param>
			/// <returns></returns>
			public string CreateForEach(DataJuggler.Net6.DataTable table)
			{
            ...
            #region GetCompareLine(DataJuggler.Net6.DataTable table, string primaryKeyName)
            /// <summary>
            ...
            /// <returns></returns>
            public string GetCompareLine(DataJuggler.Net6.DataTable table, string primaryKeyName)
			{
			...
			public void InitializeStrings(List<DataField> fields)
			{
				...
				foreach(DataJuggler.Net6.DataField field in fields)
				{
			...
			#region LoadField(DataJuggler.Net6.DataField field)
			public string LoadField(DataJuggler.Net6.DataField Field)
			{
				// String Builder  
				StringBuilder sb = new StringBuilder("this.");
			...
			#region NullField(DataJuggler.Net6.DataField field)
			public string NullField(DataJuggler.Net6.DataField Field)
			{
				// Create StringBuilder
            ...
            #region ParseFieldValue(DataJuggler.Net6.DataField field)
            /// <summary>
            /// Parse the field value
            /// </summary>
            /// <param name="field"></param>
            /// <returns></returns>
            public string ParseFieldValue(DataJuggler.Net6.DataField field)
			{
				// Create StringBuilder Object
				StringBuilder sb = new StringBuilder();
			...
			#region SaveObject(DataJuggler.Net6.DataTable table)
			/// <summary>
			...
			/// <param name="table"></param>
			/// <returns></returns>
			public string SaveObject(DataJuggler.Net6.DataTable table)
			{
				// Create New Object Name
			...
			#region UpdateLine(DataJuggler.Net6.DataField field)
			public string UpdateLine(DataJuggler.Net6.DataField Field)
			{
			...
			private void WriteAddMethod(DataJuggler.Net6.DataTable table)
			{
			...
			{	
				// Write Each Class
				foreach(DataJuggler.Net6.DataTable table in tables)
				{
			...
			private void WriteConstructor(DataJuggler.Net6.DataTable table)
			{
			...
			#region WriteCreateTableMethod(DataJuggler.Net6.DataTable table)
			private void WriteCreateTableMethod(DataJuggler.Net6.DataTable table)
			{
				...
				// Write BeginRegion "CreateTable(DataJuggler.Net6.DataTable table)";
				line = "CreateTable(DataJuggler.Net6.DataTable table)";
				BeginRegion(line);

				// Write Method Name
				line = "private void CreateTable(DataJuggler.Net6.DataTable table)";
				WriteLine(line);
				...
				// Instanciate table
				line = "this.table = new DataJuggler.Net6.DataTable();";
				WriteLine(line);

				// Create field For Adding To Fields Collection
				line = "DataJuggler.Net6.DataField field = new DataJuggler.Net6.DataField();";
				WriteLine(line);
				...
				foreach(DataJuggler.Net6.DataField Field in table.ActiveFields)
				{
					// Write Blank Line
					WriteLine();
					...
					line = "field = new DataJuggler.Net6.DataField();";
					WriteLine(line);
			...
			#region WriteDataClassVariables(DataJuggler.Net6.DataTable table)
			private void WriteDataClassVariables(DataJuggler.Net6.DataTable table)
			{
				// local StringBuilder
				StringBuilder sb = new StringBuilder();
			...
			#region WriteDeleteChanges(DataJuggler.Net6.DataTable table)
			private void WriteDeleteChanges(DataJuggler.Net6.DataTable table)
			{
			...
			private void WriteExportToDataRowMethod(DataJuggler.Net6.DataTable dataTable)
			{
				...
				// Create row
				DataJuggler.Net6.DataRow dataRow = new DataRow(dataTable);
			...
			#region WriteGetIndex(DataJuggler.Net6.DataTable table)
			private void WriteGetIndex(DataJuggler.Net6.DataTable table)
			{
			...
			#region WriteInitialChanges(DataJuggler.Net6.DataTable table)
			private void WriteInitialChanges(DataJuggler.Net6.DataTable table)
			{
			...
			#region WriteLoadMethodFromDataRow(DataJuggler.Net6.DataTable table)
			private void WriteLoadMethodFromDataRow(DataJuggler.Net6.DataTable table)
			{
				// Local Variable
				string line = "";
			...
			#region WriteLoadMethods(DataJuggler.Net6.DataTable table)
			private void WriteLoadMethods(DataJuggler.Net6.DataTable table)
			{	
			...
			#region WriteMethods()
			private void WriteMethods(DataJuggler.Net6.DataTable table)
			{
				// Begin Region Constructor
				BeginRegion("Methods");
			...
			#region WriteProperties(DataJuggler.Net6.DataTable table) void
			private void WriteProperties(DataJuggler.Net6.DataTable table)
			{
			...
			public void WriteReferences(ReferencesSet references, bool requireDelegatesReference = false)
			{
                ...
                try
                {
                    ...
                    {  
                        ...
                        // if this reference name equals DataJuggler.Net6.Enumerations
                    ...
                    if ((requireDelegatesReference) && (!hasDelegateReference))
                    {
                        ...
                        // write out the reference for DataJuggler.Net6.Delegates
                    ...
                    if ((requireDelegatesReference) && (!hasEnumerationsReference))
                    {
                        ...
                        // write out the reference for DataJuggler.Net6.Enumerations
                        WriteReference(referenceObject);
                    }
